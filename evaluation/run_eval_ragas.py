...
检索层：ragas.metrics.context_precision / context_recall
生成层：ragas.metrics.faithfulness / answer_relevancy

ground_truth.json 中每条包含 reference（完整参考答案），
与 RAGAs 指标输入格式完全对齐，无需子类化。
