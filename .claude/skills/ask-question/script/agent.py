...
# gRPC keepalive 配置：避免 Milvus Lite 服务端因 too_many_pings 断开连接
# 使用正确的 gRPC channel option key（grpc.keepalive_time_ms 而非 keepalive_time）
_GRPC_KEEPALIVE_MS = 60000  # 60 秒 ping 一次，避免过于频繁触发 ENHANCE_YOUR_CALM
...
class RAGKnowledgeAgent(AgentBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.milvus_client = MilvusClient(milvus_db_path, grpc_options={
        ...
        # 加载 collection 到内存（Milvus 要求 load 后才能 search）
    ...
    def _ensure_connection(self):
        ...
        try:
            ...
            try:
                ...
                # 重连后需要重新加载 collection 到内存
                self.milvus_client.load_collection(self.collection_name)
                logger.info("Milvus client reconnected and collection loaded successfully")
